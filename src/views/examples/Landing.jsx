                  ...
                  <Card className="bg-gradient-secondary shadow">
                    <CardBody className="p-lg-5">
                      {alert.message ? (
                        ...
                        <React.Fragment>
                          <h4 className="mb-1">Have a Query?</h4>
                          <p className="mt-0">
                            Submit the form below and let our expert help you..
                          </p>
                          <FormGroup
...
const connectedLandingPage = connect(mapState, actions)(Landing);
export { connectedLandingPage as Landing };
